...
**59** // fetch each record in result set **60** for ( $counter = 0; $row = mysql\_fetch\_row( $result ); **61** $counter++ ) **62** { **63** // build table to display results **64** print( "<tr>" ); **65 66** foreach ( $row as $key => $value ) **67** print( "<td>$value</td>" ); **68 69** print( "</tr>" ); **70** } // end for **71 72** mysql_close( $database ); **73** ?><!-- end PHP script --> **74** </table> **75** </body> **76** </html>
